...
import {
  transition
} from "./chunk-RFGSW45Q.js";
import {
  attachComponent,
  detachComponent
} from "./chunk-QPWF7OAB.js";
import {
  createColorClasses,
  hostContext
...
} from "./chunk-GULSLUUH.js";
import {
  shouldUseCloseWatcher
} from "./chunk-7TDZ3TIS.js";
  ...
  componentDidLoad() {
    {
      rIC(() => __async(this, null, function* () {
        ...
        if (!config.getBoolean("_testing")) {
          import("./index-ceb5RaMT-66LK6CV4.js").then((module) => module.startTapClick(config));
        }
        if (config.getBoolean("statusTap", isHybrid)) {
          import("./status-tap-5DQ7Fc4V-XX535CBE.js").then((module) => module.startStatusTap());
        }
        if (config.getBoolean("inputShims", needInputShims())) {
          const platform = isPlatform(window, "ios") ? "ios" : "android";
          import("./input-shims-DyOpfTg6-HFZWS7VA.js").then((module) => module.startInputShims(config, platform));
        }
        const hardwareBackButtonModule = yield import("./hardware-back-button-CPLxO-Ev-PV6GGAZ2.js");
...
var RouterOutlet = class {
  ...
  connectedCallback() {
    return __async(this, null, function* () {
      ...
      this.gesture = (yield import("./swipe-back-BKw2CAHc-M52AS7TG.js")).createSwipeBackGesture(this.el, () => !this.gestureOrAnimationInProgress && !!this.swipeHandler && this.swipeHandler.canStart(), () => onStart(), (step) => {
        var _a;
...
@ionic/core/dist/esm/ion-app_8.entry.js:
   ...
   *)
*/
//# sourceMappingURL=ion-app_8.entry-FSTOEQWO.js.map
